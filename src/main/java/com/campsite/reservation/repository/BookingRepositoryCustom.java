...
public interface BookingRepositoryCustom {
	...
	/**
	 * Look for all bookings where: 
	 * booking.dateRange.to <= to OR booking.dateRange.from >= from
	 * Returns all bookings ordered by dateRange.from
	 */
	Flux<Booking> findByDateRange(DateRangeVO dateRange);
	
	/**
	 * Same as findByDateRange but excluding a specific bookingId, useful when looking
	 * for availability to modify an existing booking.
	 * Returns all bookings ordered by dateRange.from
	 */
